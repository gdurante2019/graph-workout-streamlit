...
public class WorkoutStepMesg extends Mesg   {
    ...
    static {
        ...
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(3, 4);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_steps", 134, 1, 0, ""));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 6);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_time", 134, 1000, 0, "s"));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 7);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_distance", 134, 100, 0, "m"));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 8);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_calories", 134, 1, 0, "calories"));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 9);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_hr", 134, 1, 0, "% or bpm"));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 10);
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 11);
        subfield_index++;
        workoutStepMesg.fields.get(field_index).subFields.add(new SubField("secondary_target_repeat_power", 134, 1, 0, "% or watts"));
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 12);
        workoutStepMesg.fields.get(field_index).subFields.get(subfield_index).addMap(1, 13);
        subfield_index++;
    ...
    /**
     * Get secondary_target_repeat_steps field
     * Comment: # of repetitions
     *
     * @return secondary_target_repeat_steps
     */
    public Long getSecondaryTargetRepeatSteps() {
        return getFieldLongValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_STEPS);
    }
     ...
     * Comment: # of repetitions
     *
     * @param secondaryTargetRepeatSteps
     */
    public void setSecondaryTargetRepeatSteps(Long secondaryTargetRepeatSteps) {
        setFieldValue(20, 0, secondaryTargetRepeatSteps, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_STEPS);
    }

    /**
     * Get secondary_target_repeat_time field
     * Units: s
     *
     * @return secondary_target_repeat_time
     */
    public Float getSecondaryTargetRepeatTime() {
        return getFieldFloatValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_TIME);
    }
     ...
     * Units: s
     *
     * @param secondaryTargetRepeatTime
     */
    public void setSecondaryTargetRepeatTime(Float secondaryTargetRepeatTime) {
        setFieldValue(20, 0, secondaryTargetRepeatTime, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_TIME);
    }

    /**
     * Get secondary_target_repeat_distance field
     * Units: m
     *
     * @return secondary_target_repeat_distance
     */
    public Float getSecondaryTargetRepeatDistance() {
        return getFieldFloatValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_DISTANCE);
    }
     ...
     * Units: m
     *
     * @param secondaryTargetRepeatDistance
     */
    public void setSecondaryTargetRepeatDistance(Float secondaryTargetRepeatDistance) {
        setFieldValue(20, 0, secondaryTargetRepeatDistance, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_DISTANCE);
    }

    /**
     * Get secondary_target_repeat_calories field
     * Units: calories
     *
     * @return secondary_target_repeat_calories
     */
    public Long getSecondaryTargetRepeatCalories() {
        return getFieldLongValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_CALORIES);
    }
     ...
     * Units: calories
     *
     * @param secondaryTargetRepeatCalories
     */
    public void setSecondaryTargetRepeatCalories(Long secondaryTargetRepeatCalories) {
        setFieldValue(20, 0, secondaryTargetRepeatCalories, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_CALORIES);
    }

    /**
     * Get secondary_target_repeat_hr field
     * Units: % or bpm
     *
     * @return secondary_target_repeat_hr
     */
    public Long getSecondaryTargetRepeatHr() {
        return getFieldLongValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_HR);
    }
     ...
     * Units: % or bpm
     *
     * @param secondaryTargetRepeatHr
     */
    public void setSecondaryTargetRepeatHr(Long secondaryTargetRepeatHr) {
        setFieldValue(20, 0, secondaryTargetRepeatHr, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_HR);
    }

    /**
     * Get secondary_target_repeat_power field
     * Units: % or watts
     *
     * @return secondary_target_repeat_power
     */
    public Long getSecondaryTargetRepeatPower() {
        return getFieldLongValue(20, 0, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_POWER);
    }
     ...
     * Units: % or watts
     *
     * @param secondaryTargetRepeatPower
     */
    public void setSecondaryTargetRepeatPower(Long secondaryTargetRepeatPower) {
        setFieldValue(20, 0, secondaryTargetRepeatPower, Profile.SubFields.WORKOUT_STEP_MESG_SECONDARY_TARGET_VALUE_FIELD_SECONDARY_TARGET_REPEAT_POWER);
    }
