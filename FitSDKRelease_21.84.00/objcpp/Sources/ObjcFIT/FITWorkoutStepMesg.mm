...
// SecondaryTargetRepeatSteps - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatStepsValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatStepsSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatStepsSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt32)getSecondaryTargetRepeatSteps
{
    return ([super getFieldUINT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatStepsSubField]);
}

- (void)setSecondaryTargetRepeatSteps:(FITUInt32)secondaryTargetRepeatSteps
{
    [super setFieldUINT32ValueForField:20 andValue:(secondaryTargetRepeatSteps) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatStepsSubField];
} 
// SecondaryTargetRepeatTime - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatTimeValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatTimeSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatTimeSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITFloat32)getSecondaryTargetRepeatTime
{
    return ([super getFieldFLOAT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatTimeSubField]);
}

- (void)setSecondaryTargetRepeatTime:(FITFloat32)secondaryTargetRepeatTime
{
    [super setFieldFLOAT32ValueForField:20 andValue:(secondaryTargetRepeatTime) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatTimeSubField];
} 
// SecondaryTargetRepeatDistance - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatDistanceValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatDistanceSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatDistanceSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITFloat32)getSecondaryTargetRepeatDistance
{
    return ([super getFieldFLOAT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatDistanceSubField]);
}

- (void)setSecondaryTargetRepeatDistance:(FITFloat32)secondaryTargetRepeatDistance
{
    [super setFieldFLOAT32ValueForField:20 andValue:(secondaryTargetRepeatDistance) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatDistanceSubField];
} 
// SecondaryTargetRepeatCalories - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatCaloriesValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatCaloriesSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatCaloriesSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITUInt32)getSecondaryTargetRepeatCalories
{
    return ([super getFieldUINT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatCaloriesSubField]);
}

- (void)setSecondaryTargetRepeatCalories:(FITUInt32)secondaryTargetRepeatCalories
{
    [super setFieldUINT32ValueForField:20 andValue:(secondaryTargetRepeatCalories) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatCaloriesSubField];
} 
// SecondaryTargetRepeatHr - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatHrValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatHrSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatHrSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITWorkoutHr)getSecondaryTargetRepeatHr
{
    return ([super getFieldUINT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatHrSubField]);
}

- (void)setSecondaryTargetRepeatHr:(FITWorkoutHr)secondaryTargetRepeatHr
{
    [super setFieldUINT32ValueForField:20 andValue:(secondaryTargetRepeatHr) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatHrSubField];
} 
// SecondaryTargetRepeatPower - SecondaryTargetValue Field - Sub Field 
- (BOOL)isSecondaryTargetRepeatPowerValid
{
    ...
    if(![super canField:20 supportSubField:(FITUInt16)FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatPowerSubField]) {
        return FIT_FALSE;
    }

    return field->IsValueValid(0, FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatPowerSubField) == FIT_TRUE ? TRUE : FALSE;
}

- (FITWorkoutPower)getSecondaryTargetRepeatPower
{
    return ([super getFieldUINT32ValueForField:20 forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatPowerSubField]);
}

- (void)setSecondaryTargetRepeatPower:(FITWorkoutPower)secondaryTargetRepeatPower
{
    [super setFieldUINT32ValueForField:20 andValue:(secondaryTargetRepeatPower) forIndex:0 andSubFieldIndex:FITWorkoutStepMesgSecondaryTargetValueFieldSecondaryTargetRepeatPowerSubField];
} 
